...
export default function ServiceVisualEngPage(props:ServiceModel) {
  ...
  const items = [
    {
      title:"Planificación interpretativa",
      desc:"Producción de exposiciones, curaduría y montaje."
    },
    {
      title:"Generación de concursos y convocatorias",
      desc:""
    },
    {
      title:"Fundraising",
